            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="p-6 flex flex-col h-full">
                  ...
                  <p className="text-foreground mb-6 italic text-body flex-grow">
                    "{testimonial.content}"
                  </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-card border border-primary-300 dark:border-primary-400/30 rounded-xl overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg hover:border-primary-400 dark:hover:border-primary-400/50 hover:transform hover:scale-105 hover:-translate-y-1">
              <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                ...
                <div className="p-6">
                  <h3 className="text-card-title font-bold mb-2">{t('pages:testimonials.successStories.madalina.name')}</h3>
                  <p className="text-caption text-muted-foreground mb-4">{t('pages:testimonials.successStories.madalina.program')}</p>
                  <div className="mb-4">
            ...
            <div className="bg-card border border-primary-300 dark:border-primary-400/30 rounded-xl overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg hover:border-primary-400 dark:hover:border-primary-400/50 hover:transform hover:scale-105 hover:-translate-y-1">
              <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                ...
                <div className="p-6">
                  <h3 className="text-card-title font-bold mb-2">{t('pages:testimonials.successStories.carina.name')}</h3>
                  <p className="text-caption text-muted-foreground mb-4">{t('pages:testimonials.successStories.carina.program')}</p>
                  <div className="mb-4">
                    <div className="flex justify-between text-caption mb-1">
