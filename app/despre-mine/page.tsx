        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-20">
            <div>
              ...
              <p className="text-muted-foreground text-body mb-8 leading-relaxed pt-4">
          ...
          <div className="max-w-4xl mx-auto mb-20">
            <h2 className="text-section font-bold mb-6 text-center">{t('common:about.philosophy').split(' ')[0]} <span className="text-primary-600">{t('common:about.philosophy').split(' ')[1]}</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-card border border-primary-200 dark:border-primary-900/30 p-6 rounded-lg shadow-md transition-all duration-300 hover:transform hover:scale-105 hover:border-primary-400 dark:hover:border-primary-700 hover:shadow-lg">
                <h3 className="text-card-title font-bold mb-2">{t('common:about.principles.personalization.title')}</h3>
                <p className="text-muted-foreground text-body">
                  {t('common:about.principles.personalization.description')}
                </p>
              </div>
              <div className="bg-card border border-primary-200 dark:border-primary-900/30 p-6 rounded-lg shadow-md transition-all duration-300 hover:transform hover:scale-105 hover:border-primary-400 dark:hover:border-primary-700 hover:shadow-lg">
                <h3 className="text-card-title font-bold mb-2">{t('common:about.principles.scientific.title')}</h3>
                <p className="text-muted-foreground text-body">
                  {t('common:about.principles.scientific.description')}
                </p>
              </div>
              <div className="bg-card border border-primary-200 dark:border-primary-900/30 p-6 rounded-lg shadow-md transition-all duration-300 hover:transform hover:scale-105 hover:border-primary-400 dark:hover:border-primary-700 hover:shadow-lg">
                <h3 className="text-card-title font-bold mb-2">{t('common:about.principles.sustainability.title')}</h3>
                <p className="text-muted-foreground text-body">
                  {t('common:about.principles.sustainability.description')}
                </p>
              </div>
              <div className="bg-card border border-primary-200 dark:border-primary-900/30 p-6 rounded-lg shadow-md transition-all duration-300 hover:transform hover:scale-105 hover:border-primary-400 dark:hover:border-primary-700 hover:shadow-lg">
                <h3 className="text-card-title font-bold mb-2">{t('common:about.principles.education.title')}</h3>
                <p className="text-muted-foreground text-body">
          ...
          <div className="max-w-4xl mx-auto">
            <h2 className="text-section font-bold mb-6 text-center">{t('pages:about.certifications.title').split(' ')[0]} <span className="text-primary-600">{t('pages:about.certifications.title').split(' ').slice(1).join(' ')}</span></h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="bg-card border border-primary-200 dark:border-primary-900/30 p-6 rounded-lg shadow-md transition-all duration-300 hover:transform hover:scale-105 hover:border-primary-400 dark:hover:border-primary-700 hover:shadow-lg">
                <h3 className="text-card-title font-bold mb-2">{t('pages:about.certifications.formal.title')}</h3>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground text-body">
              ...
              <div className="bg-card border border-primary-200 dark:border-primary-900/30 p-6 rounded-lg shadow-md transition-all duration-300 hover:transform hover:scale-105 hover:border-primary-400 dark:hover:border-primary-700 hover:shadow-lg">
                <h3 className="text-card-title font-bold mb-2">{t('pages:about.certifications.international.title')}</h3>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground text-body">
            ...
            <section id="partners" className="py-12 px-6 lg:px-12 mb-12">
              <h2 className="text-section font-bold mb-6 text-center">{t('pages:about.partners.title').split(' ')[0]} <span className="text-primary-600">{t('pages:about.partners.title').split(' ')[1]}</span></h2>
              <div className="flex flex-col gap-6 max-w-4xl mx-auto">
                ...
                >
                  <div className="bg-gradient-to-br from-[#f7cfd8]/50 to-[#ffe3e8]/50 hover:from-[#f7cfd8]/60 hover:to-[#ffe3e8]/60 border border-primary-200 rounded-lg shadow-sm p-6 flex flex-col transition-all duration-300 hover:-translate-y-2 hover:shadow-md">
                    <h4 className="text-card-title font-semibold mb-3 text-center">Scitec Nutrition</h4>
                    <p className="text-muted-foreground text-body mb-4 text-center">
                      {t('pages:about.partners.scitec.description')}
                    </p>
                    <p className="text-caption font-medium text-primary-600 mb-4 text-center">{t('pages:about.partners.scitec.promoCode')}</p>
                    <div className="text-center min-w-[44px] min-h-[44px]">
                      <button className="inline-block bg-primary-500 text-white rounded-full py-2 px-4 hover:bg-primary-600 transition min-w-[44px] min-h-[44px]" aria-label={t('pages:about.partners.scitec.button')}>
                ...
                >
                  <div className="bg-gradient-to-br from-[#f7cfd8]/50 to-[#ffe3e8]/50 hover:from-[#f7cfd8]/60 hover:to-[#ffe3e8]/60 border border-primary-200 rounded-lg shadow-sm p-6 flex flex-col transition-all duration-300 hover:-translate-y-2 hover:shadow-md">
                    <h4 className="text-card-title font-semibold mb-3 text-center">GymHyper</h4>
                    <p className="text-muted-foreground text-body mb-4 text-center">
                      {t('pages:about.partners.gymhyper.description')}
                    </p>
                    <div className="text-center mb-4">
                      <p className="text-caption font-medium text-primary-600 min-w-[44px] min-h-[44px]">{t('pages:about.partners.gymhyper.promoCode')}</p>
                    </div>
                    <div className="text-center">
                      <button className="inline-block bg-primary-500 text-white rounded-full py-2 px-4 hover:bg-primary-600 transition min-w-[44px] min-h-[44px]" aria-label={t('pages:about.partners.gymhyper.button')}>
                ...
                >
                  <div className="bg-gradient-to-br from-[#f7cfd8]/50 to-[#ffe3e8]/50 hover:from-[#f7cfd8]/60 hover:to-[#ffe3e8]/60 border border-primary-200 rounded-lg shadow-sm p-6 flex flex-col transition-all duration-300 hover:-translate-y-2 hover:shadow-md">
                    <h4 className="text-card-title font-semibold mb-3 text-center">Cocosolis</h4>
                    <p className="text-muted-foreground text-body mb-4 text-center">
                      {t('pages:about.partners.cocosolis.description')}
                    </p>
                    <p className="text-caption font-medium text-primary-600 mb-4 text-center min-w-[44px] min-h-[44px]">{t('pages:about.partners.cocosolis.promoCode')}</p>
                    <div className="text-center">
                      <button className="inline-block bg-primary-500 text-white rounded-full py-2 px-4 hover:bg-primary-600 transition min-w-[44px] min-h-[44px]" aria-label={t('pages:about.partners.cocosolis.button')}>
